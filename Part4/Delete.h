...
#include <string>
    ...
    std::string deleteAccount(const std::string& id,const char tweetsFile [], const char usersFile [], const char friendFile []);
    ...
    bool removeIdFromYourFollowers(const std::string& clientID,const char friendsFile []);
